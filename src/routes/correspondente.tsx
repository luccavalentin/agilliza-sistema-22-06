...
const groups: PortalNavGroup[] = [
    ...
    items: [
      ...
      { label: "Flash IA", to: "/correspondente/crm/flash-ia", icon: BrainCircuit },
      {
        ...
        children: [
          ...
          { label: "Cadastro de Cliente", to: "/correspondente/crm/cadastro", icon: UserPlus },
  ...
  },
  {
    ...
    items: [
      { label: "Cadastros Gerais", to: "/correspondente/gestao", icon: Database },
    ],
  },
  {
    label: "Configurações",
...
export const Route = createFileRoute("/correspondente")({
  head: () => ({
    meta: [{ title: "Correspondente — Plataforma Agilliza" }],
  }),
  component: () => (
